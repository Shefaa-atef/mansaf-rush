...
function botChew(){if(!botAudio||botAudio.state!=='running')return;const t=botAudio.currentTime,o=botAudio.createOscillator(),gain=botAudio.createGain();o.type='triangle';o.frequency.setValueAtTime(130,t);o.frequency.exponentialRampToValueAtTime(60,t+.10);gain.gain.setValueAtTime(.018,t);gain.gain.exponentialRampToValueAtTime(.001,t+.12);o.connect(gain);gain.connect(botAudio.destination);o.start(t);o.stop(t+.13);}
